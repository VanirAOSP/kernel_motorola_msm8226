...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -fstrict-aliasing
HOSTCXXFLAGS = -O3 -fstrict-aliasing
...
KBUILD_CFLAGS	+= -O3 -fstrict-aliasing
endif
